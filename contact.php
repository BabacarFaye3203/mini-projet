...
if($_SERVER['REQUEST_METHOD']="POST" and isset($_POST["okContact"])){
    ...
    if($res){
        ...
        echo"erreur lors de l'envoie. Veuillez réessayer ou verifier vos informations personnellles";
    }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse"  >
      <ul class="navbar-nav" id="navbarNav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php">Temoignages</a>
        </li>
        <li class="nav-item">
...
<form action="contact.php" method="POST" class="needs-validation" novalidate>
        ...
        <button type="submit" class="btn btn-primary w-100" name="okContact">Envoyer</button>
</form>
